...
class Car : public person	// Single public inheritance, inherits the public functions and other suff as public 
{
	protected:
	    ...
	    string Model[10] = {"Sonata", "3 series","S class", "R8", "Model S", "Rapid", "Polo", "Camry", "Mustang"};
	
	    string Color[10] = {"Red", "black", "yellow", "Blue", "Red", "Brown", "Silver", "Black", "grey"};
	
	    string Max_speed[10] = {"220 Km/h", "250 Km/h", "250 Km/h", "300 Km/h", "330 Km/h", "200 Km/h", "150 Km/h", "190 Km/h", "250 Km/h"};
	
	    int Price[10] = {100, 200, 500, 500, 400, 70, 90, 80, 350};
